...
<template>
  <div>
    <v-carousel hide-delimiters cycle>
      <v-carousel-item src="assets/img/home/slider4.jpg">
      ...
      <v-carousel-item src="assets/img/home/slider2.jpg">
        <v-row class="fill-height" align="center" justify="center">
          <div class="display-2 white--text pl-5 pr-5 hidden-sm-only">
            <strong>Upto 60% + Extra 10%</strong>
          </div>
      ...
      <v-carousel-item src="assets/img/home/slider3.jpg">
        <v-row class="fill-height" align="center" justify="center">
          <div class="display-2 white--text pl-5 pr-5 hidden-sm-only">
            <strong>Upto 60% + Extra 10%</strong>
          </div>
      ...
      <v-carousel-item src="assets/img/home/slider1.jpg">
        <v-row class="fill-height" align="center" justify="center">
          <div class="display-2 white--text pl-5 pr-5 hidden-sm-only">
            <strong>Upto 60% + Extra 10%</strong>
          </div>
